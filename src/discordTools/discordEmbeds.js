...
// Handle online/offline transitions and AFK tracking
if (isOnline) {
  ...
  // AFK state changes
  if (isAfk && !afkSince[steamId]) {
    // Just went AFK - add active time up to this point
...
// Append total in brackets
status = status.replace(/\n?$/, '');
status += ` (${wipeTotalShort})\n`;
// Location column
